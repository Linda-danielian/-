...
class target():
    def __init__(self):
        self.points = 0
        self.live = 1
        # FIXED: don't work!!! How to call this functions when object is created?
        # так же, как и в создании шарика, в gun похожая проблема
    ...
    def move_target(self):
        ...
        self.vx *= 0.995
        self.set_coords()
        if (self.x >= 800 - self.r) or (self.x <= 0 + self.r):
            self.vx*=-1
